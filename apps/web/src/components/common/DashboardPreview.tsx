...
export default function DashboardPreview() {
  return (
    <section id="dashboard-preview">
      <Container>
        <div className="mt-10 flex flex-col gap-10 rounded-3xl border border-zinc-800 bg-zinc-900 p-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <input
                className="h-11 w-72 rounded-xl border border-zinc-700 bg-[#18181B] px-4 outline-none placeholder:text-zinc-500"
