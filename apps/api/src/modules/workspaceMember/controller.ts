...
export const getWorkspaceMembers = asyncHandler(
  async (req: Request, res: Response) => {
    const members = await workspaceMemberService.getWorkspaceMember(
...
export const updateMemberRole = asyncHandler(
  async (req: Request, res: Response) => {
    const response = await workspaceMemberService.updateMemberRole(
      req.params.workspaceId as string,
...
export const removeMember = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    return res
      .status(StatusCode.OK)
      .json(
        new ApiResponse(StatusCode.OK, null, "Member removed successfully."),
      );
  },
);
